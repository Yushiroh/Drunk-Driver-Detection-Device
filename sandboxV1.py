...
class scene3:
    ...
    def run(self, mouse, clicker):
        ...
        if ret is True:
            ...
            croppedFrame = frameORIG[110:330,167:502]
            cv2.rectangle(frame, (167,110), (502,330), Black, 3)
            frame = cv2.rotate(frame, cv2.ROTATE_90_COUNTERCLOCKWISE)
            frame = pygame.surfarray.make_surface(frame)

            #pygame.draw.rect(frame, Black, pygame.Rect(200,120,200,200), 3)
        ...
        if timerTick > 10 and timerTick < 20 and timerTickState:
            faceReg = counterFont.render("3", 1, Black)
            self.display.blit(faceReg, (90, 0, 160, 20))

        if timerTick > 20 and timerTick < 40 and timerTickState:
            
            faceReg = counterFont.render("2", 1, Black)
            self.display.blit(faceReg, (90, 0, 160, 20))

        if timerTick > 40 and timerTick < 60 and timerTickState:
        ...
        if timerTick == 60:
            print("CAPTURED")
            cv2.imwrite("registeredFace.jpg", croppedFrame)
    ...
    def run(self, mouse, clicker):
        ...
        if timerTick == 90:
            ...
            for elements in regFaces:
                global faceCounter
                result = DeepFace.verify(regFaces[faceCounter], 'registeredFace.jpg')
                ...
                if result["verified"] == True:
                    ...
                    faceCounter +=1 
                    faceCounter = 0 if faceCounter == 5 else faceCounter
